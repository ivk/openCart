...
class AdminPage(BasePage, ABC):
    ...
    def is_unauthorized(self, content):
        self.logger.info(f"{self.class_name}: Unauthorized user")
    ...
    def login(self, username, password):
        self.logger.info("%s: Do login as %s" % (self.class_name, username))
    ...
    def logout(self):
        self.logger.info(f"{self.class_name}: Logout from admin section")
    ...
    def product_page(self):
        self.logger.info(f"{self.class_name}: We are on the Product page")
    ...
    def add_product(self, prod_name, model, seo):
        self.logger.info("%s: Adding a new product: %s %s %s" % (self.class_name, prod_name, model, seo))
